...
{"0": {
    ...
    "doc": "FreeRTOS basic",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32mx_xlp_sk.X | PIC32MX274 XLP Starter Kit | . | pic32mx470_curiosity.X | Curiosity PIC32MX470 Development Board | . | pic32mx_eth_sk2.X | PIC32 Ethernet Starter Kit | . |   |   | . Setting up Curiosity PIC32MX470 Development Board . | Connect mini USB cable to the ‘Debug USB’ connector(J3) on the board to the computer | . Setting up PIC32 Ethernet Starter Kit . | Connect the Debug USB port on the board to the computer using a mini USB cable | . Setting up PIC32MX274 XLP Starter Kit . | Connect micro USB cable to the ‘Debug USB’ connector(J9) on the board to the computer. | . ",
    ...
    "doc": "FreeRTOS basic",
    "title": "Running the Application",
    "content": ". | Build and program the application using its IDE | The LED indicates the success or failure. | The LED toggles on success i.e. each time when the Task2 or Task3 receives a valid message | . | . Refer to the following table for LED name: . | Board | LED Name | . | Curiosity PIC32MX470 Development Board | LED1 | . | PIC32 Ethernet Starter Kit | LED1 | . | PIC32MX274 XLP Starter Kit | LED1(RED) | . |   |   | . ",
    "url": "http://localhost:4000/core_apps_pic32mx/apps/rtos/freertos/basic_freertos/readme.html#running-the-application",
